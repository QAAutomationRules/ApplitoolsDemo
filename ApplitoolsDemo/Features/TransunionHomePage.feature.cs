...
#line 12
 testRunner.Given(string.Format("the Transunion Home Page is a certain {0}", browserSize), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 13
...
#line 14
 testRunner.Then(string.Format("the Home Page Images should match the proper {0}", browserSize), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
